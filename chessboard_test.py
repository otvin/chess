...
def test_board_cache():
    ...
    b.load_from_fen("1k6/p7/8/8/8/8/P7/KR6 b - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("k7/p7/8/8/8/8/P7/KR6 w - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("k7/p7/8/8/8/8/P7/K6R b - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("1k6/p7/8/8/8/8/P7/K6R w - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("1k5R/p7/8/8/8/8/P7/K7 b - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("7R/pk6/8/8/8/8/P7/K7 w - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("k7/p7/8/8/8/8/P7/K6R w - - 0 1")
    print(c.compute_hash(b))


    b.load_from_fen("1k6/p7/8/8/8/8/P7/K1R5 w - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("1k6/p7/8/8/8/8/P7/KR6 b - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("k7/p7/8/8/8/8/P7/KR6 w - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("k7/p7/8/8/8/8/P7/K1R5 b - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("1k6/p7/8/8/8/8/P7/K1R5 w - - 0 1")
    print(c.compute_hash(b))
    b.load_from_fen("1k6/p7/8/8/8/8/P7/KR6 b - - 0 1")
