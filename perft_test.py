...
def perft_series():
    ...
    perft_test("r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1", [6, 24, 9467, 422333, 15833292])
    perft_test("r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1", [6, 24, 9467, 422333, 15833292])
    ...
    perft_test("n1n5/1Pk5/8/8/8/8/5Kp1/5N1N w - - 0 1", [15,189,2718,35804])
    perft_test("8/PPPk4/8/8/8/8/4Kppp/8 w - - 0 1", [9,70,800,8638])
    perft_test("n1n5/PPPk4/8/8/8/8/4Kppp/5N1N w - - 0 1", [15,210,3253,47828])
